...
def zad3():
    ...
    file = "zad03_0.010000.txt"
    data001 = np.loadtxt(file)
    file = "zad03_0.100000.txt"
    data010 = np.loadtxt(file)
    file = "zad03_1.000000.txt"
    data100 = np.loadtxt(file)

    file = "zad03_blad_0.010000.txt"
    data001_blad = np.loadtxt(file)
    file = "zad03_blad_0.100000.txt"
    data010_blad = np.loadtxt(file)
    file = "zad03_blad_1.000000.txt"
    ...
    plt.title("Z3 - Metoda RK4 - rozwiazanie")
    ...
    plt.savefig("zad3.png",bbox_inches='tight')

    plt.figure()

    plt.title("Z3 - Metoda RK4 - blad globalny")
    ...
    ax_inset.set_ylim([0.0, 0.0000004])

    plt.savefig("zad3blad.png",bbox_inches='tight')
